...
// dd($admin->id);
        ...
        $orders = $orders->ecommerceOrders()->orderBy('orders.id', 'DESC')->get();
        ...
        return DataTables::of($orders)
            ...
            ->editColumn('order_ref', function ($orders) {
                return '<a style="color:green;" href="' . route('ecomorder.show', $orders->id ??'NA') . '" target="_blank">
            ...
            ->editColumn('coupon_code', function ($orders) {
                return $orders->coupon_code;
            })
            ->editColumn('discount_amount', function ($orders) {
                return $orders->discount_amount;
            })
            ...
            ->addColumn('actions', function ($orders) {
                return '<div class="btn-group">
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1" style="">
                        <a target="_blank" class="dropdown-item d-flex align-items-center" href="' . route('ecomorder.show', ['ecomorder' => $orders->id ?? 'NA']) . '">
                        ...
                        View Details </a>
                        <a target="_blank" class="dropdown-item d-flex align-items-center" href="' . route('ecomorder.invoice', ['orderId' => $orders->id]) . '">
