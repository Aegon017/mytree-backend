                        ...
                        <div class="modal-body p-0">
                            <div class="card p-3 p-lg-4">
                                <button type="button" class="btn-close ms-auto" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                                <div class="text-center text-md-center mb-4 mt-md-0">
                                    <h1 class="mb-0 h4">Update City</h1>
                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-12 mb-4">
...
@section('script')
    @parent
    <script>
        var cityUrl = "{{ route('cities.index') }}";
        var cityStore = "{{ route('cities.store') }}";
        var cityEdit = '{{ route('cities.edit', ':id') }}';
        var getcity = '{{ route('cities', ':id') }}';
        var cityUpdate = '{{ route('cities.update', ':id') }}';
        var statusUpdate = '{{ route('cities-status') }}';
        var deleteUpdate = '{{ route('cities-delete') }}';
    </script>
