                                                        ...
                                                        <div class="row mb-4">
                                                            <div class="col-lg-12 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea id="description" name="content" style="display:none;"></textarea>
                        ...
                        <div class="modal-body p-0">
                            <div class="card p-3 p-lg-4">
                                <button type="button" class="btn-close ms-auto" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                                <div class="text-center text-md-center mb-4 mt-md-0">
                                    <h1 class="mb-0 h4">Update Blog</h1>
                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-12 mb-4">
                                                            ...
                                                            <div class="col-lg-12 col-sm-12">
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">
                                                                        ...
                                                                        <textarea id="description_edit" name="content" style="display:none;"></textarea>
...
@section('script')
    @parent
    <script>
        var blogUrl = "{{ route('blogs.index') }}";
        var blogStore = "{{ route('blogs.store') }}";
        var blogEdit = '{{ route('blogs.edit', ':id') }}';
        var blogUpdate = '{{ route('blogs.update', ':id') }}';
        var statusUpdate = '{{ route('blogs-status') }}';
        var deleteUpdate = '{{ route('blogs-delete') }}';
