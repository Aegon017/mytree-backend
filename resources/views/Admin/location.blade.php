@extends('Admin.layouts.guest_layout')
        ...
        <section class="vh-100 d-flex align-items-center justify-content-center">
            <div class="container">
                <div class="row align-items-center ">
                    ...
                    <form class="mt-4" method="POST" action="{{ route('store-location') }}">
                        @csrf
                        <input type="hidden" name="longitude" id="longitude" >
                        <input type="hidden" name="latitude" id="latitude" >
                        <h1 class="mt-5">Log Your<span class="text-primary">Location</span> To Procced</h1>
                        <p class="lead my-4">Click Procced butto and accpect allow location then ,we will redirect to dashboard.</p>
                        <!-- <a href="javascript:void(0)" class="btn btn-gray-800 d-inline-flex align-items-center justify-content-center mb-4">
                    ...
                    <!-- <img class="img-fluid w-75" src="{{ asset('frontEnd/images/fav-icon.png') }}" alt="500 Server Error"> -->
                    </div>
                </div>
            </div>
        </section>
...
@section('script')
    ...
    <script>
     ...
     initGeolocation();
    //  var storeEmpLoc = '{{ route('store-location') }}';
