...
<div class="container">
    ...
    <input type="hidden"  class="form-control" id="roleBased"  value="{{$roleId}}">
    <br />
    <!-- Add Item Modal -->
    <div class="col-lg-4">
        <!-- Modal Content -->
                    ...
                    <div class="modal-body p-0">
                        <div class="card p-3 p-lg-4">
                            ...
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h4">Add {{$roleName}}</h1>
                            </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="role" class="form-control" id="role"  value="{{$roleId}}">
                                                    ...
                                                    <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" maxlength="10" name="mobile" class="form-control mobile_class" id="mobile" placeholder="Enter mobile">
                                                                <span class="error_msg" id="mobileErr"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Profile Image</label>
                                                                <input type="file" name="image" class="form-control-file" id="image" accept=".png, .jpg, .jpeg">
                                                    ...
                                                    <div class="row mb-4">
                                                        <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="error_msg" id="passwordErr"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Confirm Password</label>
                                                                <input type="password" name="cpassword" class="form-control" onkeyup="checkPwd();" id="cpassword" placeholder="Enter Confirm Password">
                                                                <span class="error_msg" id="cpasswordErr"></span>
                                                            </div>
                                                        </div>
                ...
                <form id="update_item" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-0">
                        <div class="card p-3 p-lg-4">
                            <button type="button" class="btn-close ms-auto" data-bs-dismiss="modal" aria-label="Close"></button>
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h4">Update {{$roleName}}</h1>
                            </div>
                            <div class="modal-body">
                            <div class="row">
                                        <div class="col-12 mb-4">
                                            <div class="card border-0 shadow components-section">
                                                <div class="card-body">
                                                    ...
                                                    <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="id" class="form-control"
                                                                    ...
                                                                    <input type="hidden" name="role" class="form-control" id="roleEdit"  value="">
                                                                <input type="text" name="name" class="form-control" id="name_edit" placeholder="Enter name">
                                                        ...
                                                        <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"> Email</label>
                                                                <input type="text" name="email" class="form-control" id="email_edit" placeholder="Enter email">
                                                                <span class="error_msg" id="email_editErr"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                    <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"> Mobile</label>
                                                                <input type="text" maxlength="10" name="mobile" class="form-control mobile_class" id="mobile_edit" placeholder="Enter mobile">
                                                                <span class="error_msg" id="mobile_editErr"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Profile Image</label>
                                                                <input type="file" name="image" class="form-control-file" id="image_edit" accept=".png, .jpg, .jpeg">
                                                                <div class="error_msg" id="image_display"></div>
                                                                <span class="error_msg" id="image_editErr"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- <div class="row mb-4">
                                                        <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Password</label>
                                                                <input type="password" class="form-control" id="password" name="password" maxlength="12" placeholder="Enter password">
                                                                <span class="error_msg" id="passwordErr"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-sm-6">
    ...
    <div class="row">
        <div class="row">
            <div class="col-md-12">
                <h1 class="h4">Manage {{$roleName}}</h1>
            </div>
        </div><br /><br />
        <div class="row">
            <div class="col-md-6">
...
@parent
<script>
    var employeeUrl = "{{ route('employee.index') }}";
    var employeeStore = "{{ route('employee.store') }}";
    var employeeEdit = '{{ route('employee.edit', ':id') }}';
    var employeeUpdate = '{{ route('employee.update',':id') }}';
    var statusUpdate = '{{ route('employee-status') }}';
    var deleteUpdate = '{{ route('employee-delete') }}';
</script>
