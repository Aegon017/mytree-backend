 <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
	...
	.st3{fill-rule:evenodd;clip-rule:evenodd;fill:#6F4A40;}
             ...
             <li class="nav-item <?php echo $__env->yieldContent('title') == 'Employee' ? 'active' : ''; ?>">
                ...
                </span><span class="sidebar-text">Manage Admins</span> </span><span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
             ...
             <li class="nav-item <?php echo $__env->yieldContent('title') == 'Reports' ? 'active' : ''; ?>">
                ...
                </span><span class="sidebar-text">Reports</span> </span><span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                             <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                         </svg></span></span>
             ...
             <li class="nav-item <?php echo $__env->yieldContent('title') == 'Roles' ? 'active' : ''; ?>">
                ...
                </span><span class="sidebar-text">Manage Roles</span> </span><span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                             <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                         </svg></span></span>
