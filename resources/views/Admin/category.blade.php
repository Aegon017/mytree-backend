...
<div class="container">
                ...
                <form id="update_item" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-0">
                        <div class="card p-3 p-lg-4">
                            <button type="button" class="btn-close ms-auto" data-bs-dismiss="modal" aria-label="Close"></button>
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h4">Update Category</h1>
                            </div>
                            <div class="modal-body">
                            <div class="row">
                                        <div class="col-12 mb-4">
    ...
    <div class="row">
        <div class="row">
            <div class="col-md-12">
                <h1 class="h4">Manage Category</h1>
            </div>
        </div><br /><br />
        <div class="row">
            <div class="col-md-6">
...
@parent
<script>
    var categoryUrl = "{{ route('category.index') }}";
    var categoryStore = "{{ route('category.store') }}";
    var categoryEdit = '{{ route('category.edit', ':id') }}';
    var categoryUpdate = '{{ route('category.update',':id') }}';
    var statusUpdate = '{{ route('category-status') }}';
    var deleteUpdate = '{{ route('category-delete') }}';
</script>
