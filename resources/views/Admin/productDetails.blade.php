    ...
    <div class="container">
        ...
        <div class = "card-wrapper">
            <div class = "card">
                ...
                <div>
                    <ul class="slides">
                        ...
                        <li class="slide-container">
                            ...
                            <div class="nav">
                                <label for="img-{{ count($product->images) + 1 }}" class="prev">&#x2039;</label>
                ...
                <h2 class = "product-title">{{$product->name}} ({{$product->nick_name}})</h2>
                <a href = "#" class = "product-link">{{$product->botanical_name}} </a>
                ...
                <div class = "purchase-info">
                    ...
                    <button type = "button" class = "btn">{{$product->category->name ?? 'NA'}}</button>
                </div>
                </div>
